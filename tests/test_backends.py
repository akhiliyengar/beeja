"""Tests for skill.backends — factory and discovery logic."""

from __future__ import annotations

import pytest

from skill.backends import (
    VSCodeBridgeBackend,
